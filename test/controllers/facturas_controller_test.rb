...
class FacturasControllerTest < ActionController::TestCase
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post :create, factura: { cantidad: @factura.cantidad, fecha: @factura.fecha, monto: @factura.monto, nombre: @factura.nombre, numero: @factura.numero, text: @factura.text, total: @factura.total }
    end
  ...
  test "should update factura" do
    patch :update, id: @factura, factura: { cantidad: @factura.cantidad, fecha: @factura.fecha, monto: @factura.monto, nombre: @factura.nombre, numero: @factura.numero, text: @factura.text, total: @factura.total }
    assert_redirected_to factura_path(assigns(:factura))
  end
